...
<template>
  <div ref="container" class="vue-horizontal-list">
    <div v-if="width.window > _options.navigation.start" class="vhl-navigation">
      <div v-if="_hasPrev" class="vhl-btn-left" @click="prev">
      ...
      <div v-if="_hasNext" class="vhl-btn-right" @click="next">
        <svg :fill="_options.navigation.color" width="32px" height="32px" viewBox="0 0 24 24">
          <path
    ...
    <div class="vhl-container" :style="_style.container">
      <div ref="list" class="vhl-list" :class="_options.list.class" :style="_style.list">
        <div
          v-for="item in items"
          ref="item"
          class="vhl-item"
...
export default {
  ...
  methods: {
    ...
    go(position) {
      ...
      this.$refs.list.scrollTo({ top: 0, left, behavior: "smooth" });
    },
    /**
