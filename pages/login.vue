  ...
  <v-app>
    <div class="form-body container-fluid">
      <div class="website-logo">
        <a href="index.html">
          <div class="logo">
            <img class="logo-size" src="../static/login/logo-light.svg" alt>
          </div>
        </a>
      </div>
      <div class="row">
        <div class="img-holder">
          ...
          <div class="info-holder">
            <img src="../static/login/Text.svg" alt>
          </div>
        </div>
          ...
          <div class="form-content">
            <div class="form-items">
              <div class="text-center">
                <img src="../static/v.png" height="100" alt="Vue Material Admin Template" />
              </div>
...
.website-logo .logo {
  display: inline-block;
  background-image: url("../static/login/logo-light.svg");
...
.img-holder .bg {
  ...
  width: 100%;
  height: 100%;
  background-image: url("../static/login/login.svg");
